...
* OpenShift {ocp-min-version}+ or later
...
Install from: link:https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/cli_tools/openshift-cli-oc#cli-getting-started[OpenShift CLI Documentation,window=_blank]
...
Install from: link:https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/virtualization/getting-started#virt-using-the-cli-tools[OpenShift Virtualization Documentation,window=_blank]
