...
Solution: Install the QEMU guest agent in your VM. See link:https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/virtualization/managing-vms#virt-installing-qemu-guest-agent[Installing the QEMU guest agent,window=_blank] for installation instructions.
...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/virtualization/getting-started#virt-using-the-cli-tools[virtctl Commands Reference,window=_blank]
