...
* **OpenShift {ocp-min-version}+** installed and running on a supported platform
...
NOTE: The minimal HyperConverged spec above uses all default settings. For advanced configuration options, see the https://docs.openshift.com/container-platform/{ocp-docs-version}/virt/install/installing-virt.html#virt-customizing-storage-profile_installing-virt[official documentation,window=_blank].
...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/virtualization/installing[OpenShift Virtualization Installation Documentation,window=_blank]
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/virtualization/getting-started[OpenShift Virtualization Getting Started,window=_blank]
