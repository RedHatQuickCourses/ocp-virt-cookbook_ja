...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/virtualization/backup-and-restore[Backup and Restore by Using VM Snapshots - Red Hat Documentation,window=_blank]
