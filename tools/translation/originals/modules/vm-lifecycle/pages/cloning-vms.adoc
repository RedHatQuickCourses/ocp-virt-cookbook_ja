...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/virtualization/managing-vms#virt-creating-vms-by-cloning-pvcs[Creating VMs by cloning PVCs,window=_blank]
