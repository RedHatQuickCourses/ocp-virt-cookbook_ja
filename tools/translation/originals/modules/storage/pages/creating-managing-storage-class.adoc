...
----  
OpenShift Documentation: https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/storage/using-container-storage-interface-csi#persistent-storage-csi-ebs
...
OpenShift Documentation: https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/storage/persistent-storage-using-local-storage
...
OpenShift documentation: https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/storage/configuring-persistent-storage
...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/storage/configuring-persistent-storage[OpenShift - Configuring Persistent Storage,window=_blank]
