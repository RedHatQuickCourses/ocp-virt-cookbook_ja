...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/virtualization/networking#virt-connecting-vm-to-ovn-secondary-network[OpenShift Virtualization - Connecting a VM to an OVN secondary network,window=_blank]
