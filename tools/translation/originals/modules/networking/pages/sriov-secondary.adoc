...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/hardware_networks/about-sriov[OpenShift Hardware Networks,window=_blank]
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/virtualization/networking#virt-attaching-vm-to-sriov-network[Connecting a VM to an SR-IOV Network,window=_blank]
