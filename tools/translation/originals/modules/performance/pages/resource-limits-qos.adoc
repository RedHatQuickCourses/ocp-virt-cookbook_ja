...
* link:https://docs.openshift.com/container-platform/{ocp-docs-version}/virt/managing_vms/advanced_vm_management/virt-working-with-resource-quotas-for-vms.html[Working with Resource Quotas for VMs - OpenShift Documentation,window=_blank]
...
* link:https://docs.openshift.com/container-platform/{ocp-docs-version}/applications/quotas/quotas-setting-per-project.html[Resource Quotas Per Project - OpenShift Documentation,window=_blank]
