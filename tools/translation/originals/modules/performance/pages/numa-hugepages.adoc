...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/scalability_and_performance/what-huge-pages-do-and-how-they-are-consumed[Optimizing Memory with Huge Pages - OpenShift Documentation,window=_blank]
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/scalability_and_performance/cnf-numa-aware-scheduling[Scheduling NUMA-aware Workloads - OpenShift Documentation,window=_blank]
