...
* link:https://docs.openshift.com/container-platform/{ocp-docs-version}/scalability_and_performance/using-cpu-manager.html[Using CPU Manager and Topology Manager - OpenShift Documentation,window=_blank]
