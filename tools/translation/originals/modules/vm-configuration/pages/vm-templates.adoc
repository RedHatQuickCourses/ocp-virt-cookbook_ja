...
https://docs.redhat.com/en/documentation/openshift_container_platform/{ocp-docs-version}/html/virtualization/managing-vms#virt-creating-vms-from-templates[Creating virtual machines from templates,window=_blank]
